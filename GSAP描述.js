...
function animateFallIn(element) {
    // 随机选择四个方向之一
    const directions = [
        { xPercent: -100, yPercent: -100, rotation: -30 }, // 左上
        { xPercent: 100, yPercent: -100, rotation: 30 },   // 右上
        { xPercent: -100, yPercent: 100, rotation: -30 },  // 左下
        { xPercent: 100, yPercent: 100, rotation: 30 }     // 右下
    ];
    ...
    gsap.from(element, {
        ...
        // 动画属性
        duration: 1.5,
        xPercent: randomDirection.xPercent,      // 随机X方向
        yPercent: randomDirection.yPercent,      // 随机Y方向
        opacity: 0,
        rotation: randomDirection.rotation,      // 随机旋转角度
        scale: 0.8,
...
function addInteractivity() {
    ...
    routePoints.forEach(point => {
        point.addEventListener('click', function() {
            ...
            alert(`Clicked on ${location}, detailed historical background information can be displayed here.`);
        });
    });
    ...
    workerTombs.forEach(tomb => {
        tomb.addEventListener('click', function() {
            ...
            alert(`Chinese Worker: ${worker}\nJob: Railroad Worker\nStatus: Deceased\nBurial Location: Under the tracks`);
        });
    });
    ...
    if (submitButton) {
        submitButton.addEventListener('click', function() {
            ...
            if (storyText.trim()) {
                alert('Thank you for sharing your Hakka story! Your story will be saved.');
            } else {
